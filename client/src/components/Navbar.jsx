    ...
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
        ...
        className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative'> 
          <div className='flex items-center gap-3 cursor-pointer'> 
            ...
            <h1 className='font-semibold hidden md:block text-lg'>PrepBot</h1> 
          </div> 
          ...
          <div className='flex items-center gap-6 relative'> 
            ...
            <div className='relative'> 
              ...
              {showCreditPopup && (  
                ...
                <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50'> 
                  <p className='text-sm text-gray-600 mb-4'> Running low on credits? Keep your interview going.</p> 
                  <button onClick={() => navigate("/pricing")} className='w-full bg-black text-white py-2 rounded-lg text-sm'>Add credits</button>      
                </div>  
              )}
            ...
            <div className='relative'>  
              ...
              {showUserPopup && ( 
                <div className='absolute right-9 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
