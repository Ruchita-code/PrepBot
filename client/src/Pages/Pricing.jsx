...
function Pricing() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-fuchsia-50 py-16 px-6'>
      ...
      <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
        {plans.map((plan)=>{
          ...
          return(
            ...
            ${
              isSelected
                ? "border-fuchsia-800 shadow-2xl bg-white"
            ...
            `}>
              ...
              {/* Badge */}
              {plan.badge && (
                <div className='absolute top-6 right-6 bg-fuchsia-800 text-white text-xs px-4 py-1 rounded-full shadow'>{plan.badge}
                </div>
              )}
              ...
              {/* Price */}
              <div className='mt-4'>
                <span className='text-3xl font-bold text-fuchsia-800'>
                  {plan.price}
                </span>
              ...
              <div className='mt-6 space-y-3 text-left'>
                {plan.features.map((feature, i) => (
                  <div key={i} className='flex items-center gap-3'>
                    <FaCheckCircle className='text-fuchsia-800 text-sm'/>
              ...
              {!plan.default && 
                ...
                onClick={(e) => {e.stopPropagation();
                  ...
                  ? "bg-fuchsia-800 text-white hover:opacity-90"
                  : "bg-gray-100 text-gray-700 hover:bg-fuchsia-50"
                }`}>
